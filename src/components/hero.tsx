...
export const Hero: FC = () => {
  ...
  return (
    <section className="bg-[url('./mobile/image-hero.jpg')] md:bg-[url('./desktop/image-hero.jpg')] bg-cover h-[calc(100vh-1rem)] md:max-h-[650px] px-6 md:px-40 flex justify-center md:justify-normal items-center">
      <h1
